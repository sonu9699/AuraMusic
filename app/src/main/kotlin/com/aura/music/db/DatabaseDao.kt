...
import com.aura.music.constants.AlbumSortType
import com.aura.music.constants.ArtistSongSortType
import com.aura.music.constants.ArtistSortType
import com.aura.music.constants.PlaylistSortType
import com.aura.music.constants.SongSortType
import com.aura.music.db.entities.Album
import com.aura.music.db.entities.AlbumArtistMap
import com.aura.music.db.entities.AlbumEntity
import com.aura.music.db.entities.PlayCountEntity
import com.aura.music.db.entities.AlbumWithSongs
...
import com.aura.music.db.entities.EventWithSong
...
import com.aura.music.db.entities.PlaylistSongMap
import com.aura.music.db.entities.RelatedSongMap
import com.aura.music.db.entities.SearchHistory
import com.aura.music.db.entities.SetVideoIdEntity
import com.aura.music.db.entities.Song
import com.aura.music.db.entities.SongAlbumMap
import com.aura.music.db.entities.SongArtistMap
import com.aura.music.db.entities.SongEntity
import com.aura.music.db.entities.SongWithStats
import com.aura.music.db.entities.TagEntity
import com.aura.music.db.entities.PlaylistTagMap
import com.aura.music.db.entities.PlaylistWithTags
import com.aura.music.extensions.reversed
import com.aura.music.extensions.toSQLiteQuery
import com.aura.music.models.MediaMetadata
import com.aura.music.models.toMediaMetadata
import com.aura.music.ui.utils.resize
...
interface DatabaseDao {
    ...
    fun getAllSkips(): Flow<List<com.aura.music.db.entities.SongSkipEntity>>

    @Query("SELECT * FROM song_skip WHERE songId = :songId LIMIT 1")
    suspend fun getSkip(songId: String): com.aura.music.db.entities.SongSkipEntity?

    @Upsert
    suspend fun upsertSkip(skip: com.aura.music.db.entities.SongSkipEntity)
