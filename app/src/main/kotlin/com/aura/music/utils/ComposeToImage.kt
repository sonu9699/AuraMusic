...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: com.aura.music.ui.component.LyricsGlassStyle? = null
    ): Bitmap = withContext(Dispatchers.Default) {
        val style = glassStyle ?: com.aura.music.ui.component.LyricsGlassStyle.FrostedDark
    ...
    private fun AppLogo(
        ...
        val rawLogo = context.getDrawable(R.drawable.ic_auramusic_concept)?.toBitmap(logoSize, logoSize)
