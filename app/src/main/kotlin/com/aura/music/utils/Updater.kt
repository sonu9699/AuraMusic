...
import com.aura.music.App
import com.aura.music.constants.GitHubReleasesEtagKey
import com.aura.music.constants.GitHubReleasesFingerprintKey
import com.aura.music.constants.GitHubReleasesJsonKey
import com.aura.music.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/nikhilvishwakarma00/AuraMusic/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "AuraMusic")
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/nikhilvishwakarma00/AuraMusic/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://github.com/nikhilvishwakarma00/AuraMusic/releases/latest/download/"
        val architecture = BuildConfig.ARCHITECTURE
        return if (architecture == "universal") {
            baseUrl + "AuraMusic.apk"
        } else {
