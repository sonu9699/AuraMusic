...
import com.aura.music.canvas.AuraMusicCanvas
import com.aura.music.canvas.CanvasArtwork
...
import com.aura.music.constants.MaxCanvasCacheSizeKey
...
fun Thumbnail(
    ...
    val auramusicCanvasEnabled by rememberPreference(AuraMusicCanvasKey, false)
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.aura.music.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.aura.music.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
