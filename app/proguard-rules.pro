...
-keep class com.aura.music.models.PersistQueue { *; }
-keep class com.aura.music.models.PersistPlayerState { *; }
-keep class com.aura.music.models.QueueData { *; }
-keep class com.aura.music.models.QueueType { *; }
-keep class com.aura.music.playback.queues.** { *; }
